...
public class WidgetInstruction extends AppCompatActivity {
    ...
    getCurrentVersion();
        Button continuetomain = (Button) findViewById(R.id.continuetomain);

        continuetomain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(WidgetInstruction.this, HomeActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse
                        ("market://details?id=org.pcc.repeatinglocalnotifications")));
                dialog.dismiss();
            }
        });
